...
export default function ProjectCard({ project, children }: Props) {
  return (
    <div
      ...
      class="project-card group/card rounded-xl border-t border-zinc-700 shadow-md shadow-black hover:shadow-xl hover:shadow-black hover:border-orange-400 transition-all duration-500 ease-in-out"
    >
